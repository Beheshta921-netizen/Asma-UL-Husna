...
const namesGrid =
    document.getElementById("namesGrid");

const searchInput =
    document.getElementById("searchInput");

const nameCount =
    document.getElementById("nameCount");
...
const audio =
    document.getElementById("recitationAudio");
...
const reciteAllButton =
    document.getElementById("reciteAllButton");
...
const playingAnimation =
    document.getElementById("playingAnimation");
...
function updatePlayButton() {
    ...
    if (audio.paused) {
        ...
        playingAnimation.classList.remove(
            "active"
        );
        ...
        playingAnimation.classList.add(
            "active"
        );
...
reciteAllButton.addEventListener(
    "click",
    function () {
